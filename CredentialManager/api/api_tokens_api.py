...
class ApiTokensApi(object):
    ...
    def delete(self, item_id, **kwargs):
        ...
        **PERMISSIONS: Owner/Admin may execute this action.**
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.delete_with_http_info(item_id, **kwargs)
            return data
    ...
    def delete_with_http_info(self, item_id, **kwargs):
        ...
        **PERMISSIONS: Owner/Admin may execute this action.**
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.delete_with_http_info(item_id, async_req=True)
        >>> result = thread.get()
    ...
    def get_api_token_by_id(self, item_id, **kwargs):
        ...
        **PERMISSIONS: Owner/Admin may execute this action.**
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_api_token_by_id(item_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_api_token_by_id_with_http_info(item_id, **kwargs)
        else:
            (data) = self.get_api_token_by_id_with_http_info(item_id, **kwargs)
            return data

    def get_api_token_by_id_with_http_info(self, item_id, **kwargs):
        '''Get API Token details by ID

        **PERMISSIONS: Owner/Admin may execute this action.**
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_api_token_by_id_with_http_info(item_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in params['kwargs'].items():
            if key not in all_params:
                raise TypeError("Got an unexpected keyword argument '%s'"
                                " to method get_api_token_by_id" % key)
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'item_id' is set
        if 'item_id' not in params or params['item_id'] is None:
            raise ValueError("Missing the required parameter `item_id` when calling `get_api_token_by_id`")
